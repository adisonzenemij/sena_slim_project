<?php
    ...
    use MyApp\Models\MySql\DeleteModel as modelDelete;
    ...
    class DeleteController {
        public function data(Request $request, Response $response, $arguments, $flag = false) {
            ...
            $deleteData = $request->getParsedBody();
            # Agregar $deleteData a $queryParams con la clave
            $queryParams['deleteData'] = $deleteData;
            ...
            # Validar y obtener datos del modelo en formato JSON
            if (!$flag && $apiJsonError) { $resultJson = modelDelete::data($queryParams); }
